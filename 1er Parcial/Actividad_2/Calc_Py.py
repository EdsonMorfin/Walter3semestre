...
if __name__ == "__main__":
    ...
    opc = 1
    while opc != 8:
        while opc >= 1 and opc <= 8:
            menu()
            opc=int(input("Seleccione su opción[1-7]"))
            if (opc == 1):
                ...
                Mi_Calculadora.num1=pedir_valor("Dame el valor para convertirlo en cuadrado: ")
                print("Resultado: "+str(Mi_Calculadora.Cuadrado())+"\n\n")
            elif (opc == 6):
                Mi_Calculadora.num1=pedir_valor("Dame el valor para convertirlo en inverso: ")
                print("Resultado: "+str(Mi_Calculadora.Inverso())+"\n\n")
            elif (opc == 7):
                Mi_Calculadora.num1=pedir_valor("Dame el valor para convertirlo en cubo: ")
                print("Resultado: "+str(Mi_Calculadora.Cubo())+"\n\n")
            elif (opc == 8):
                break               
            else:
                pass
        else:
            print("Por favor introduzca una opción válida [1..8]\n\n")
            opc = 1
